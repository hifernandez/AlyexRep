<?php
	...
	if ($stmt = $mysqli->prepare("CALL sp_insertClienteCatSAS(?,?,?,?,?,?,?)"))
	{
		//Vinculando parametros a la consultad
		if (!$stmt->bind_param("iiissis",$p_ID_giro,$p_ID_cp,$p_ClaveCliente,$p_RazonSocial,$p_RFCCliente,$p_NumProveedor,$p_CalleNum)) {
