					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-8">
					  <ul class="nav navbar-nav">
							<li id="btnDocCrea"><a href="#" 
								onclick="pintaDocumentoSel(1)">Registro de insidencias en puntos de revisión</a></li>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" 
									aria-haspopup="true" aria-expanded="false">Círculos de calidad <span class="caret"></span></a>
