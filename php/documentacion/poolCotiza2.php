    ...
    <table  id="dgPoolCotiza" title="Pool cotizaciones" class="easyui-datagrid" style="width:auto;height:450px;"
...
<script>
   /* $(document).ready(function ()
	{
         $('#dgPoolCotiza').datagrid('reload');   // reload the user data
		
    });*/
    function cambiaEstatusCot(tipoOperacion) {
        switch(tipoOperacion){
            case "APROBAR":
                                var row = $('#dgPoolCotiza').datagrid('getSelected');
                                if (row){
